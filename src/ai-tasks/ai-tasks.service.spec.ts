...
describe('AiTasksService', () => {
  ...
  it('increments message sequence from the latest conversation message', async () => {
  ...
  it('rejects a busy conversation', async () => {
  ...
  it('hides a conversation owned by another user', async () => {
    tx.conversation.updateMany.mockResolvedValue({ count: 0 });
  ...
  it('marks the task failed and releases conversation when enqueueing fails', async () => {
